                ...
                return<div key={index} className="bloc pos-rel flex  flex-justify-start flex-align-center">
                    ...
                    <a href={`/unit/${item.uid}`}>
                        ...
                        >
                            ...
                            #{item.uid}
                            {(item.status != "3"
                                ? (<span className="px-2 border-r-8 ml-2 tx-green ims-bg-primary-light pa-1 tx-sm ">
                                    Available
                                </span>)
                                : <></>
                            )}
                            {(item.price && item.price.retail_price
                                ? <span className="px-2">${item.price.retail_price}</span>
                                : <></>
                            )}
